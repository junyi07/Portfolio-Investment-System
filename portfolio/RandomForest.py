...
def loadDataSet(fileName):
    ...
    train = myData.iloc[0:6505, :]
    test = myData.iloc[6505:, :]
    train_data = []
    test_data = []
    train_lable = []
    test_lable = []
...
def test():
    ...
    # ---------------------------------------CSV-----------------------------------------------------------------------------------
    csvfile = open("predict_svm.csv", "w")
    ...
    ROC_result['false_positive_rate']=false_positive_rate
    ROC_result['true_positive_rate'] = true_positive_rate
    ROC_result.to_csv('ROC_for_randomforest.csv')
